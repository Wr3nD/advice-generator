...
const App = () => {
    ...
    return (
        <div className="max-w-[1440px] h-screen w-screen m-auto bg-[#1f2632] flex flex-col justify-center items-center">
            <div className={mobile ? "w-[90%] m-auto bg-[#323a49] h-[320px] rounded-2xl flex flex-col  items-center relative" : "w-2/6  h-[34%] bg-[#323a49]  rounded-2xl flex flex-col  items-center relative"}>
            ...
            <div className={mobile ? "attribution absolute bottom-0 " : " absolute bottom-0 attribution 0"}>
